...
const handlers = {
  ...
  '/api/auth/logout': require('../backend/handlers/auth/logout'),
  '/api/auth/forgot-password': require('../backend/handlers/auth/forgot-password'),
  '/api/auth/reset-password': require('../backend/handlers/auth/reset-password'),
